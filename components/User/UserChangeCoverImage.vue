...
const onFileChanged = () => {
   ...
   props.userDetailData.cover_image = image.value[0].name;
}
const changeCoverImage = async() => {
    ...
    if(res.result === true){
        ...
        warning.value = [false, 'Cover Image changed successfully'];
        setTimeout(() => {
...
<template>
    <div class="p-4">
        <h1 class="text-2xl font-bold">Change Cover Image</h1>
        <div class="mt-5">
                ...
                <div class="flex flex-col gap-5 mt-5">
                    ...
                    <div class="flex justify-end gap-5 mt-5">
                        <UButton color="primary" label="Change Cover Image" :loading="loadingBtn" @click="changeCoverImage" />
                        <UButton color="gray" label="Cancel" @click="$emit('isOpenCoverImage')" />
                    </div>
